...
import { Display, Title, Heading, Paragraph } from "@gofinance/go-ui";
  ...
  return (
    <Display pushTop pushBottom>
      <Container maxWidth="md">
        ...
        <Paragraph>
          Welcome to <a href="https://go.finance">https://go.finance</a> and/or{" "}
          <a href="https://app.go.finance">https://app.go.finance</a>, our
          website-hosted user interface (each the “Interface” or “App”) provided
          by GO Finance (“we”, “our”, or “us”). The Interface provides access to
        ...
        <Paragraph>
          ...
          must contact us by sending an email to info@go.finance so that we can
